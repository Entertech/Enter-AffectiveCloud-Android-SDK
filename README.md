# Enter-AffectiveCloud-Andriod-SDK [![Download](https://api.bintray.com/packages/hzentertech/maven/affectivecloud/images/download.svg?version=1.3.8)](https://bintray.com/hzentertech/maven/affectivecloud/1.3.8/link)
- [简介](#简介)
- [Demo](#demo)
- [集成](#集成)
...
```groovy
implementation 'cn.entertech:affectivecloud:1.3.8'
```
