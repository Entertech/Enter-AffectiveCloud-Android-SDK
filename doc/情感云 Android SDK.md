# 回车情感云平台SDK(Android) [![Download](https://api.bintray.com/packages/hzentertech/maven/affectivecloud/images/download.svg?version=1.0.2)](https://bintray.com/hzentertech/maven/affectivecloud/1.0.2/link)
